...
class PersonManager:
    ...
    def __init__(self):
        p3 = Employee('lee', 38, 'samsung', 's12', '010-1666-1111')
        self.memberdict[p3.No] = p3
        p4 = Person('choi', 25)
        self.memberdict[p4.No] = p4
        p5 = Person('lee', 38)
        self.memberdict[p5.No] = p5
        p6 = Employee('choi', 25, 'abd','s34', '010-1166-1221')
        self.memberdict[p6.No] = p6
